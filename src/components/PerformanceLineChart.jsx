    ...
    >
      <ResponsiveContainer width="100%" height={280}>
        <LineChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 10 }}>
          ...
          <Line type="monotone" dataKey={scoreDataKey} stroke={scoreColor} strokeWidth={3} dot={{ fill: scoreColor, r: 4 }} activeDot={{ r: 6 }} connectNulls />
          <Line type="monotone" dataKey={puttsDataKey} stroke={puttsColor} strokeWidth={3} dot={{ fill: puttsColor, r: 4 }} activeDot={{ r: 6 }} connectNulls />
        </LineChart>
      </ResponsiveContainer>
    </ChartCard>
);
