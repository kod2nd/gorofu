...
const AddClubModal = ({ open, onClose, onSave, clubToEdit, myClubs = [] }) => {
  ...
  useEffect(() => {
    if (isEditMode && clubToEdit) {
      ...
      const sanitizedClubData = Object.keys(initialClubState).reduce(
        (acc, key) => {
          acc[key] =
            clubToEdit[key] !== null && clubToEdit[key] !== undefined
